...
public class BossService {
    ...
    private void validateEmail(String email) {
        ...
        if (boss != null) {
            throw new ConflictException(String.format("[%s]는 이미 존재하는 boss 입니다. 기존 아이디로 로그인해주세요.", email));
        }
    }
    ...
    private void validateNickName(String nickName) {
        ...
        if (boss != null) {
            throw new ConflictException(String.format("[%s]는 이미 존재하는 닉네임 입니다. 다른 닉네임을 입력해주세요.", nickName));
        }
    }
}
