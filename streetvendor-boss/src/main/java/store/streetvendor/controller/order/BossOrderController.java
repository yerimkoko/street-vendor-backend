...
public class BossOrderController {
    ...
    public ApiResponse<List<OrderListToBossResponse>> checkOrders(@MemberId Long bossId, @PathVariable Long storeId, @RequestParam(required = false) OrderStatus status) {
