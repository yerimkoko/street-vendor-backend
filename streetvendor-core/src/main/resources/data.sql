...
insert into order_history(store_id, description, location_description, boss_id, member_id, order_id, payment_method, order_create_time, order_canceled_status)
values ( 1, "설명", "위치 설명", 1, 1, 1, "ACCOUNT", now(), now(),  "CASH");
