...
import static store.streetvendor.core.exception.ErrorCode.UNAUTHORIZED_EXCEPTION;
import static store.streetvendor.core.exception.ErrorCode.VALIDATION_EXCEPTION;
