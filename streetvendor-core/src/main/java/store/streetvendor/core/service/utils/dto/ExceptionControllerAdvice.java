...
import store.streetvendor.core.domain.model.exception.UnAuthorizedException;

import java.net.BindException;

import static store.streetvendor.core.domain.model.exception.ErrorCode.UNAUTHORIZED_EXCEPTION;
import static store.streetvendor.core.domain.model.exception.ErrorCode.VALIDATION_EXCEPTION;
